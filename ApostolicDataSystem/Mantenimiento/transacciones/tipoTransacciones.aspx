...
<asp:Content ID="cntTiposTransaccion" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:HiddenField ID="hdfTipoProceso" runat="server" />
    ...
    <main id="main" class="main">
        ...
        <div class="modal fade" id="mdEdicionData" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" role="dialog">
            <div class="modal-dialog modal-dialog-centered">

                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">
                            <asp:Label runat="server" ID="lblTituloModal"></asp:Label></h1>
                    ...
                    <div class="modal-body">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control text-capitalize" id="txtDescripcion" runat="server" onblur="validaTexto(this);">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" runat="server" id="btnGuardar" onserverclick="btnGuardar_ServerClick"><i class="bi bi-floppy fa-fw me-2"></i>Guardar</button>
                        <%--<asp:button CssClass="btn btn-success" runat="server" ID="btnGuardarDato" Text="Guardar" OnClick="btnGuardarDato_Click"/>--%>
                    </div>
                </div>
            </div>
        </div>
