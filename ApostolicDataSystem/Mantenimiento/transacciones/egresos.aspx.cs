    ...
    public partial class egresos : System.Web.UI.Page
    {
        ...
        private void cargarInformacionInicial(string codigo)
        {
            ...
            try
            {
                ...
                parametros.Add(new parametrosEventosInfo(_indexParametro++, _indexParametro, "tipoTransaccion", "E", "E"));
        ...
        protected void btnGuardar_ServerClick(object sender, EventArgs e)
        {
            ...
            if (validaInformacion())
            {
                try
                {
                    ...
                    parametros.Add(new parametrosEventosInfo(_indexParametro++, _indexParametro, "codigoMiembro", "0", "0"));
                    ...
                    DataSet dsResultado = sql.guardaTransaccion(parametros, "E");
                    ...
                    if (drResultado["codigo"].ToString().Equals("0"))
                    {
                        ...
                        _sweetAlertaInfo.UrlRedirect = ("../../Mantenimiento/transacciones/egresos.aspx");
