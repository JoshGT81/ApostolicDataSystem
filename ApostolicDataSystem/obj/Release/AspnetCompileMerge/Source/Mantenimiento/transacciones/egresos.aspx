<%@ Page Title="" Language="C#" MasterPageFile="~/ApostolicDataSystem.Master" AutoEventWireup="true" CodeBehind="egresos.aspx.cs" Inherits="ApostolicDataSystem.Mantenimiento.transacciones.egresos" %>

<asp:Content ID="cntEgresos" ContentPlaceHolderID="cphBody" runat="server">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Egresos del día</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
